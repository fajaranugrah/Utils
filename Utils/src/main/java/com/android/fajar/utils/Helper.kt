...
object Helper {
        ...
        get() {
            ...
            var0.registerTypeAdapter(
                ...
                JsonDeserializer { var1, var2, var3 ->
                    try {
                        return@JsonDeserializer (SimpleDateFormat(config!!.apiDateFormat)).parse(
                            var1.asJsonPrimitive.asString
                        )
            ...
            var0.registerTypeAdapter(java.lang.Boolean.TYPE,
                JsonDeserializer { var1, var2, var3 ->
                    try {
    ...
    fun getConverterFactoryList(var0: Context?): ArrayList<Any?> {
    ...
    fun parseTime(var0: Date): String {
        ...
        return if (var9 > 0L) (if (var9 / 24L > 0L) String.format(
            ...
            var2,
            var9.toInt()
        )) else (if (var11 > 0L) String.format(
            var3,
            var11.toInt()
        ) else (if (var13 > 0L) String.format(
            var4,
            var13.toInt()
        ) else var5))
    }
    ...
    fun copyToClipboard(var0: Context, var1: String?, var2: String?) {
        try {
            val var3 = var0.getSystemService(CLIPBOARD_SERVICE) as ClipboardManager
    ...
    fun copyToClipboard(var0: Context, var1: String?) {
        try {
            val var2 = var0.getSystemService(CLIPBOARD_SERVICE) as ClipboardManager
    ...
    fun getScreenSize(var0: Context): Point {
        checkPermission()
        val var1 = var0.getSystemService(WINDOW_SERVICE) as WindowManager
    ...
    /*fun shakeView(var0: View?) {
        YoYo.with(Techniques.Shake).duration(config!!.defaultAnimationDuration.toLong())
            .playOn(var0)
    }*/
    ...
    fun isOnline(var0: Context): Boolean {
        val var1 = var0.getSystemService(CONNECTIVITY_SERVICE) as ConnectivityManager
        val var2 = var1.activeNetworkInfo
        return var2 != null && var2.isConnectedOrConnecting
    }

    /*fun MD5(var0: String?): String {
        checkPermission()
        return String(a.a.a.a.a.a.a(a.a.a.a.b.a.b(var0)))
    }*/

    /*fun SHA1(var0: String?): String {
        checkPermission()
        return String(a.a.a.a.a.a.a(a.a.a.a.b.a.c(var0)))
    }*/

    fun addFragment(var0: FragmentManager, var1: Fragment?) {
        checkPermission()
        if (config!!.defaultFragmentContainerResId != -1) {
            var0.beginTransaction().replace(
                config!!.defaultFragmentContainerResId,
                var1!!
    ...
    fun getImei(var0: Context?): String {
        ...
        var var1 = ""
        try {
            val var2 = var0!!.getSystemService(PHONE_SERVICE) as TelephonyManager
            var1 = var2.deviceId
    ...
    fun parseToApiDate(var0: Date?): String {
        checkPermission()
        return SimpleDateFormat(config!!.apiDateFormat).format(var0)
    }

    fun formatCurrency(var0: Double): String {
        checkPermission()
        return DecimalFormat(config!!.currencyFormat).format(var0)
    }

    fun formatCurrency(var0: Double, var2: DecimalFormatSymbols?): String {
        checkPermission()
        return DecimalFormat(config!!.currencyFormat, var2).format(var0)
    }

    fun formatDecimal(var0: Double): String {
        checkPermission()
        return DecimalFormat(config!!.decimalFormat).format(var0)
    }

    fun formatDecimal(var0: Double, var2: DecimalFormatSymbols?): String {
        checkPermission()
        return DecimalFormat(config!!.decimalFormat, var2).format(var0)
    }
    ...
    /*fun checkPermission(var0: Context, var1: String?, var2: Boolean): Boolean {
        return if (checkPermission(var0, var1)) {
            true
        } else {
            try {
                if (var2) {
                    CustomConfirmationDialog(
                        var0,
                        string.dialog_request_permission_title,
                        String.format(
                            var0.getString(string.dialog_request_permission_content),
                            var1
                        ),
                        string.dialog_request_permission_positive_text,
                        string.dialog_request_permission_negative_text,
                        object : ButtonCallback() {
                            fun onNegative(var1: MaterialDialog?) {
                                super.onPositive(var1)
                                val var2 = Intent("android.intent.action.VIEW")
                                var2.data = Uri.parse(config!!.permissionDetailsUrl)
    ...
    fun hideSoftKeyboard(var0: Activity) {
        try {
            val var1 = var0.getSystemService(INPUT_METHOD_SERVICE) as InputMethodManager
